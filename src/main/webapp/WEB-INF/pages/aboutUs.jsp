					...
					<div id="main">
						...
						<!-- Post -->
							<section class="post">
								...
								<header class="major">
									<h2><a>About Supercrete</a></h2>
								
                                                            
                                <center><a class="horizontal-center" target="_blank">
                                    <img style="max-width:180px;margin-bottom:30px;" src="${pageContext.request.contextPath}/resources/images/Logo.PNG">	</a></center>
